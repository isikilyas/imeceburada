...
export default function FavoritesPage() {
  ...
  return (
    <div>
      <h1 className="mb-6 text-2xl font-semibold text-silver-300">{t("nav.favorites")}</h1>
      ...
      {jobs.length > 0 && (
        <section className="mb-8">
          <h2 className="mb-3 text-lg font-medium text-silver-300">{t("pages.jobsHeading")}</h2>
      ...
      {equipment.length > 0 && (
        <section className="mb-8">
          <h2 className="mb-3 text-lg font-medium text-silver-300">{t("favorites.equipmentHeading")}</h2>
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
      ...
      {materials.length > 0 && (
        <section className="mb-8">
          <h2 className="mb-3 text-lg font-medium text-silver-300">{t("pages.materialListingsHeading")}</h2>
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
