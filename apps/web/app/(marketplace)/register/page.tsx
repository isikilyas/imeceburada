...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      if (role === "CANDIDATE") {
        await registerCandidate({ email, password, fullName, city, district: districtValue, phone });
  ...
  return (
    <div className="mx-auto max-w-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <p className="text-xs text-silver-500">
          Telefon numarası, piyasa endeksine girilen verilerin doğruluğunu korumak için isteniyor — doğrulama kodu
          gerekmez, sadece bu numarayla ikinci bir hesap açılamaz.
        </p>
