...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center gap-6 py-24 text-center">
      ...
      <div>
        <h1 className="text-xl font-semibold text-silver-200">Aradığın sayfa bulunamadı</h1>
        <p className="mt-2 max-w-sm text-sm text-silver-500">
          Bağlantı hatalı olabilir ya da bu ilan/sayfa artık mevcut değil. Ana sayfadan devam edebilirsin.
        </p>
      </div>
