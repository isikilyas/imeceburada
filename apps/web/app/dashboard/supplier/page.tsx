...
export default function SupplierDashboardPage() {
  ...
  if (user?.role !== "SUPPLIER")
    return <p className="text-silver-500">Bu sayfa sadece yapı tedarik hesapları içindir.</p>;
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-2">
        <section>
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-xl font-semibold text-silver-300">İlanlarım</h2>
            <Link href="/membership" className="text-sm text-gold-400 hover:underline">
              Üyelik Durumu
            </Link>
          </div>
          <div className="space-y-3">
            {listings?.length === 0 && <p className="text-silver-500">Henüz ilan vermedin.</p>}
        ...
        <section>
          <h2 className="mb-4 text-xl font-semibold text-silver-300">Yeni Malzeme İlanı</h2>
          <p className="mb-4 text-xs text-silver-500">
            İlan yayınlamak için aktif üyeliğin ve doğrulanmış telefon numaran olmalı (üyelik sayfasından
            tamamlayabilirsin).
          </p>
