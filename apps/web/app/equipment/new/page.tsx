...
export default function NewEquipmentPage() {
  ...
  if (!user) return <p className="text-silver-500">İlan vermek için giriş yapmalısın.</p>;

  return (
    <div className="mx-auto max-w-md">
      <h1 className="mb-6 text-2xl font-semibold text-silver-300">Yeni Ekipman İlanı</h1>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {form.listingType === "SALE" ? (
          ...
          <div className="grid grid-cols-2 gap-3">
            <Field label="Günlük Ücret (₺, opsiyonel)">
              <input
                type="number"
                min={0}
            ...
            <Field label="Saatlik Ücret (₺, opsiyonel)">
              <input
                type="number"
                min={0}
