...
export const componentsDict: Record<Locale, Record<string, any>> = {
  tr: {
    ...
    listingsHub: {
      heading: "İlanlar",
      intro: "Aradığın kategoriyi seç.",
      jobsTitle: "İş İlanları",
      jobsDesc: "Usta, işçi ve teknik personel ilanları",
      candidatesTitle: "Personel Bul",
      candidatesDesc: "Meslek ve bölgeye göre iş arayan usta ve teknik personeli keşfet",
      subcontractorsTitle: "Taşeron Bul",
      subcontractorsDesc: "Faturalı iş yapan taşeron firmalarını meslek ve bölgeye göre bul",
      equipmentTitle: "Ekipman",
      equipmentDesc: "Kiralık iş makinesi ve ekipman ilanları",
      materialsTitle: "Malzeme",
      materialsDesc: "Tedarikçilerden inşaat malzemesi ilanları",
      siteRadarTitle: "Şantiye Radarı",
      siteRadarDesc: "Haritada anlık usta ve ekipman çağrısı aç",
      wageIndexTitle: "Ücret Endeksi",
      wageIndexDesc: "Bölgesel işçilik ücret endeksini canlı takip et",
      materialIndexTitle: "Malzeme Endeksi",
      materialIndexDesc: "Güncel inşaat malzemesi fiyatlarını bölgesel olarak karşılaştır",
    },
    siteMap: {
  ...
  en: {
    ...
    listingsHub: {
      heading: "Listings",
      intro: "Choose the category you're looking for.",
      jobsTitle: "Job Listings",
      jobsDesc: "Listings for skilled tradespeople, laborers, and technical staff",
      candidatesTitle: "Worker Directory",
      candidatesDesc: "Find job-seeking tradespeople and technical staff by trade and region",
      subcontractorsTitle: "Subcontractor Directory",
      subcontractorsDesc: "Find invoiced subcontractor firms by trade and region",
      equipmentTitle: "Equipment",
      equipmentDesc: "Listings for rentable heavy machinery and equipment",
      materialsTitle: "Materials",
      materialsDesc: "Construction material listings from suppliers",
      siteRadarTitle: "Site Radar",
      siteRadarDesc: "Post an urgent call for workers or equipment on the map",
      wageIndexTitle: "Wage Index",
      wageIndexDesc: "Track the regional labor wage index live",
      materialIndexTitle: "Material Index",
      materialIndexDesc: "Compare current construction material prices by region",
    },
    siteMap: {
      loading: "Loading map...",
    },
  ...
  de: {
    ...
    listingsHub: {
      heading: "Anzeigen",
      intro: "Wähle die gesuchte Kategorie.",
      jobsTitle: "Stellenanzeigen",
      jobsDesc: "Anzeigen für Fachkräfte, Arbeiter und technisches Personal",
      candidatesTitle: "Fachkräfteverzeichnis",
      candidatesDesc: "Finde arbeitssuchende Fachkräfte und technisches Personal nach Gewerk und Region",
      subcontractorsTitle: "Subunternehmerverzeichnis",
      subcontractorsDesc: "Finde rechnungsfähige Subunternehmerfirmen nach Gewerk und Region",
      equipmentTitle: "Geräte",
      equipmentDesc: "Mietanzeigen für Baumaschinen und Geräte",
      materialsTitle: "Material",
      materialsDesc: "Materialanzeigen von Lieferanten",
      siteRadarTitle: "Baustellen-Radar",
      siteRadarDesc: "Starte einen akuten Aufruf für Fachkräfte oder Geräte auf der Karte",
      wageIndexTitle: "Lohnindex",
      wageIndexDesc: "Verfolge den regionalen Lohnindex live",
      materialIndexTitle: "Materialindex",
      materialIndexDesc: "Vergleiche aktuelle Baumaterialpreise nach Region",
    },
    siteMap: {
  ...
  ru: {
    ...
    listingsHub: {
      heading: "Объявления",
      intro: "Выберите нужную категорию.",
      jobsTitle: "Вакансии",
      jobsDesc: "Объявления для мастеров, рабочих и технического персонала",
      candidatesTitle: "Каталог специалистов",
      candidatesDesc: "Найдите специалистов и технический персонал, ищущих работу, по профессии и региону",
      subcontractorsTitle: "Каталог субподрядчиков",
      subcontractorsDesc: "Найдите субподрядные фирмы, работающие по счетам, по профессии и региону",
      equipmentTitle: "Техника",
      equipmentDesc: "Объявления об аренде спецтехники и оборудования",
      materialsTitle: "Материалы",
      materialsDesc: "Объявления о материалах от поставщиков",
      siteRadarTitle: "Радар объектов",
      siteRadarDesc: "Разместите срочный вызов мастеров или техники на карте",
      wageIndexTitle: "Индекс зарплат",
      wageIndexDesc: "Следите за региональным индексом зарплат в реальном времени",
      materialIndexTitle: "Индекс материалов",
      materialIndexDesc: "Сравните текущие цены на стройматериалы по регионам",
    },
    siteMap: {
  ...
  ar: {
    ...
    listingsHub: {
      heading: "الإعلانات",
      intro: "اختر الفئة التي تبحث عنها.",
      jobsTitle: "إعلانات الوظائف",
      jobsDesc: "إعلانات للحرفيين والعمال والموظفين الفنيين",
      candidatesTitle: "دليل الحرفيين",
      candidatesDesc: "ابحث عن الحرفيين والموظفين الفنيين الباحثين عن عمل حسب المهنة والمنطقة",
      subcontractorsTitle: "دليل المقاولين من الباطن",
      subcontractorsDesc: "ابحث عن شركات المقاولات من الباطن العاملة بالفاتورة حسب المهنة والمنطقة",
      equipmentTitle: "المعدات",
      equipmentDesc: "إعلانات تأجير الآليات الثقيلة والمعدات",
      materialsTitle: "المواد",
      materialsDesc: "إعلانات مواد البناء من الموردين",
      siteRadarTitle: "رادار الموقع",
      siteRadarDesc: "انشر طلبًا عاجلاً لحرفيين أو معدات على الخريطة",
      wageIndexTitle: "مؤشر الأجور",
      wageIndexDesc: "تابع مؤشر الأجور الإقليمي مباشرة",
      materialIndexTitle: "مؤشر المواد",
      materialIndexDesc: "قارن أسعار مواد البناء الحالية حسب المنطقة",
    },
    siteMap: {
  ...
  es: {
    ...
    listingsHub: {
      heading: "Anuncios",
      intro: "Elige la categoría que buscas.",
      jobsTitle: "Ofertas de empleo",
      jobsDesc: "Anuncios para oficiales, peones y personal técnico",
      candidatesTitle: "Directorio de Profesionales",
      candidatesDesc: "Encuentra oficiales y personal técnico en busca de empleo por oficio y región",
      subcontractorsTitle: "Directorio de Subcontratistas",
      subcontractorsDesc: "Encuentra empresas subcontratistas que facturan por oficio y región",
      equipmentTitle: "Maquinaria",
      equipmentDesc: "Anuncios de maquinaria pesada y equipos en alquiler",
      materialsTitle: "Materiales",
      materialsDesc: "Anuncios de materiales de construcción de proveedores",
      siteRadarTitle: "Radar de Obra",
      siteRadarDesc: "Publica una llamada urgente de personal o maquinaria en el mapa",
      wageIndexTitle: "Índice Salarial",
      wageIndexDesc: "Sigue el índice salarial regional en vivo",
      materialIndexTitle: "Índice de Materiales",
      materialIndexDesc: "Compara los precios actuales de materiales de construcción por región",
    },
    siteMap: {
  ...
  fr: {
    ...
    listingsHub: {
      heading: "Annonces",
      intro: "Choisissez la catégorie recherchée.",
      jobsTitle: "Offres d'emploi",
      jobsDesc: "Annonces pour ouvriers qualifiés, manœuvres et personnel technique",
      candidatesTitle: "Répertoire des Professionnels",
      candidatesDesc: "Trouvez des ouvriers qualifiés et du personnel technique en recherche d'emploi par métier et région",
      subcontractorsTitle: "Répertoire des Sous-traitants",
      subcontractorsDesc: "Trouvez des entreprises sous-traitantes facturées par métier et région",
      equipmentTitle: "Matériel",
      equipmentDesc: "Annonces d'engins et d'équipements de chantier à louer",
      materialsTitle: "Matériaux",
      materialsDesc: "Annonces de matériaux de construction des fournisseurs",
      siteRadarTitle: "Radar de Chantier",
      siteRadarDesc: "Publiez un appel urgent pour du personnel ou du matériel sur la carte",
      wageIndexTitle: "Indice des Salaires",
      wageIndexDesc: "Suivez l'indice des salaires régional en direct",
      materialIndexTitle: "Indice des Matériaux",
      materialIndexDesc: "Comparez les prix actuels des matériaux de construction par région",
    },
    siteMap: {
