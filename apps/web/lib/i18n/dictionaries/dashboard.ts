...
export const dashboardDict: Record<Locale, Record<string, any>> = {
  tr: {
    ...
    companyJobDetail: {
      ...
      rejectButton: "Reddet",
      matchesHeading: "Sana Uygun Profiller",
      matchesHint: "İlanının meslek/şehir bilgisine göre otomatik sıralanmış öneriler — kural tabanlı bir eşleştirme, ayrı bir başvuru gerektirmez.",
      matchesEmpty: "Şu an bu ilana uygun profil bulunamadı.",
      matchScoreLabel: "%{{score}} uyum",
      alreadyAppliedBadge: "Zaten başvurdu",
      viewProfileLink: "Profili Gör",
    },
    subcontractor: {
  ...
  en: {
    ...
    companyJobDetail: {
      ...
      acceptButton: "Accept",
      rejectButton: "Reject",
      matchesHeading: "Suggested For You",
      matchesHint: "Automatically ranked suggestions based on your listing's trade/city — a rule-based match, applying separately isn't required.",
      matchesEmpty: "No matching profiles found for this listing yet.",
      matchScoreLabel: "{{score}}% match",
      alreadyAppliedBadge: "Already applied",
  ...
  de: {
    ...
    companyJobDetail: {
      ...
      matchesHeading: "Für dich vorgeschlagen",
      matchesHint: "Automatisch nach Gewerk/Stadt deiner Anzeige sortierte Vorschläge — ein regelbasiertes Matching, keine separate Bewerbung nötig.",
      matchesEmpty: "Für diese Anzeige wurden noch keine passenden Profile gefunden.",
      matchScoreLabel: "{{score}}% Übereinstimmung",
      alreadyAppliedBadge: "Bereits beworben",
      viewProfileLink: "Profil ansehen",
    },
    subcontractor: {
  ...
  ru: {
    ...
    companyJobDetail: {
      ...
      matchesHeading: "Рекомендовано для вас",
      matchesHint: "Автоматически отсортированные предложения на основе специальности/города вашей вакансии — это подбор по правилам, отдельная заявка не требуется.",
      matchesEmpty: "Подходящих профилей для этой вакансии пока не найдено.",
      matchScoreLabel: "{{score}}% совпадение",
      alreadyAppliedBadge: "Уже подал(а) заявку",
      viewProfileLink: "Посмотреть профиль",
    },
    subcontractor: {
  ...
  ar: {
    ...
    companyJobDetail: {
      ...
      acceptButton: "قبول",
      rejectButton: "رفض",
      matchesHeading: "مقترح لك",
      matchesHint: "اقتراحات مرتبة تلقائيًا حسب مهنة/مدينة إعلانك — مطابقة قائمة على قواعد، لا تتطلب تقديم طلب منفصل.",
      matchesEmpty: "لم يتم العثور على ملفات مطابقة لهذا الإعلان بعد.",
      matchScoreLabel: "تطابق {{score}}%",
      alreadyAppliedBadge: "تقدم بالفعل",
      viewProfileLink: "عرض الملف الشخصي",
    },
    subcontractor: {
  ...
  es: {
    ...
    companyJobDetail: {
      ...
      matchesHeading: "Sugerido para ti",
      matchesHint: "Sugerencias ordenadas automáticamente según el oficio/ciudad de tu anuncio — un emparejamiento basado en reglas, no requiere una postulación aparte.",
      matchesEmpty: "Aún no se encontraron perfiles compatibles para este anuncio.",
      matchScoreLabel: "{{score}}% de coincidencia",
      alreadyAppliedBadge: "Ya se postuló",
      viewProfileLink: "Ver perfil",
    },
    subcontractor: {
  ...
  fr: {
    ...
    companyJobDetail: {
      ...
      matchesHeading: "Suggéré pour vous",
      matchesHint: "Suggestions triées automatiquement selon le métier/la ville de votre annonce — un appariement basé sur des règles, aucune candidature séparée n'est requise.",
      matchesEmpty: "Aucun profil correspondant trouvé pour cette annonce pour le moment.",
      matchScoreLabel: "{{score}} % de correspondance",
      alreadyAppliedBadge: "A déjà postulé",
      viewProfileLink: "Voir le profil",
    },
    subcontractor: {
